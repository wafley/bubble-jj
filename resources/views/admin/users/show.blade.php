            ...
            <div class="card">
                ...
                <div class="card-body pt-2">
                    <div class="d-flex align-items-center justify-content-between mb-3">
                        <h3 class="mb-0 mark">{{ $user->name }}</h3>
                    </div>
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item">
                            ...
                            <span class="float-end">{{ $user->profile->username_1 }}</span>
                        </li>
                        <li class="list-group-item">
                            <strong>Username 2:</strong>
                            <span class="float-end">{{ $user->profile->username_2 ?? '-' }}</span>
                        </li>
                        <li class="list-group-item">
                            <strong>Role:</strong>
                            <span class="float-end">{{ $user->role->label }}</span>
                        </li>
                        <li class="list-group-item">
                            <strong>Status Akun:</strong>
                            <span class="float-end">
                                <span class="badge text-bg-{{ $user->status_color }}">
                                    {{ $user->status_label }}
                                </span>
                            </span>
                        </li>
                        <li class="list-group-item">
                            ...
                            <span class="float-end">
                                {{ $user->verified_at ? formatDate($user->verified_at) : 'Belum' }}
                            </span>
                        </li>
                    </ul>
                </div>
                <div class="card-footer text-end">
                    <a href="{{ route('users.edit', $user->id) }}" class="btn btn-sm btn-info spa-link">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    @if ($activities->isEmpty())
                        <p class="text-muted">Belum ada data aktivitas untuk user ini.</p>
                    @else
                        <ul class="list-group list-group-flush">
        ...
        $(".btn-delete").on("click", function(e) {
            ...
            ajaxRequest({
                ...
                confirm: {
                    ...
                    text: "Data user ini akan dihapus permanen bersama dengan aktivitas terkait!",
